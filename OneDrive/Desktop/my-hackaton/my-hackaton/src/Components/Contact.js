...
export default function Contact() {
  ...
  return (
    <section id="contact" className="h-screen bg-white dark:bg-gray-700 flex items-center justify-center animate-fade transition duration-200 px-4 sm:px-6">
      <div data-aos="fade-down" className="text-center">
        <h2 className="text-3xl font-bold dark:text-white">Contact Me</h2>
        <form className="mt-6 max-w-lg w-full mx-auto">
          <input type="text" placeholder="Your Name" className="w-full p-4 border rounded mb-4" />
